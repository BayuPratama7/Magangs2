                    ...
                    <tbody>
                        <?php foreach ($sebaran_list as $s): ?>
                            <tr>
                                ...
                                <td>
                                    <?= $s->wilayah ?><br>
                                    <small class="text-muted"><?= $s->provinsi ?></small>
                                </td>
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="text" name="periode" class="form-control" placeholder="2024-1" required>
                        </div>
                        <div class="col-md-6 mb-3">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input type="number" name="jumlah_mahasiswa" class="form-control" min="1" required>
                        </div>
                    </div>
                    <div class="mb-3">
